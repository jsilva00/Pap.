...
<nav class="navbar">
        <div class="max-width">
            <div class="logo">
                <a href="index.html">ESFH</a>
            </div>
            <ul class="menu" id="menu-site">
            <li><a href="index.html">Home</a></li>
            <li><a href="questionario.php"></a></li>
            <li><a href="sondagem.php">Sondagem</a></li>
            </ul>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <form class="w3-container w3-small" action="config.php" method="POST">
